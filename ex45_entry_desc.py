...
ghetto = """You had noticed on the map that the apartment was
	 ...
	 fence is the freeways' cinderblock wall. The leasing agent 
	 gets out of his car as you walk up. His cheesy 
	 car-salesman smile and the mustard on his tie are 
	 adequately amusing. "This place is a steal," he shouts. 
	 "If you're looking to save money, then this is it! First
	 I want you to notice the windows, take a real good look.
	 Wow! That's security! And peice of mind- nothing's getting 
	 ...
	 apparently the lower level of the building that you 
	 arrived at. The agent leads you down the outer basement 
	 steps and inside. The good points are the richly colored 
	 paint, the step in shower, the gold colored faucets and a 
	 laundry hookup in the bathroom. Someone sunk some money 
	 into this basement. The agent is sure to point out every 
	 detail and only gives you two minutes to look by yourself 
	 before coming back.
	 """

our_new_home = """This neighborhood is quiet and clean. You notice
	       kids playing in the front yard directly across the 
	       small lane from the six unit apartment building that
	       you are considering. You call to mind your research:
	       Three blocks away in one direction is a supermarket, 
	       a block away in another direction is a mom n' pop 
	       market. The leasing agent arrives as you do. She takes 
	       you through. A stacked washer/dryer combo are included.
	       There aren't any bars on the windows which lets you
	       appreciate the ample sunlight streaming through the 
	       thick wood blinds. A couple of windows look out to 
	       trees in neighboring yards. The leasing agent chats 
	       you up as she walks you from room to room. She mentions 
	       that she has two other veiwings here today but she
...
closet =  """In the middle of everything, thats where this apartment is.
          ...
          an hour but once you're standing in front of the tall, narrow 
          brick building that contends with historical giants on the 
          skyline you can feel the energy. The leasing agent lets
...
part_2 =  """A fresh-faced college dude greets you. He tucks
          ...
          room might have been a large closet at one time. The 
          other roomies are not at home. "We have a lot of 
          people coming to check out the room so I just want
          you to know so you're not dissappointed or anything
          that there are a lot of people interested in it. Just
          so you know." He offers to hang out with you while you 
          wait for Caitlyn to get off the phone with her (ex?) 
...
roomie = """When she finishes her argument she ducks into the kitchen
         ...
         All dishes are washed by hand and they have a fairly complicated
         recycling and composting system that Caitlyn stresses is Very 
         important.
         """          